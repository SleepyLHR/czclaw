...
This guide walks through testing the entire Web Search Skill integration with czclaw.

## Prerequisites

1. czclaw built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with czclaw.

**Steps:**

1. Start czclaw in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of czclaw launch.
...
1. Open a terminal while czclaw is running
...
**Objective:** Verify graceful shutdown of services when czclaw quits.

**Steps:**

1. With czclaw running and searches completed, quit the application
...
1. Start czclaw (ensure headless is false in config)
...
- ✅ Server auto-starts with czclaw
