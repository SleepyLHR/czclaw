...
const plugin = {
  ...
  description: 'Image and video generation tools powered by czclaw server.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      ...
      return {
        ...
        description: [
          'Generate images using czclaw server.',
          'Supports text-to-image and image-to-image generation.',
          'If the system prompt includes a czclaw media reference mapping, use mapped file paths or URLs in image/images arguments and never pass @ media tokens as tool argument values.',
    ...
    api.registerTool((ctx) => {
      ...
      return {
        ...
        description: [
          'Generate videos using czclaw server.',
          ...
          'If the system prompt includes a czclaw media reference mapping, use mapped file paths or URLs in image/images/firstFrame/referenceImages/video/videos/media arguments and never pass @ media tokens as tool argument values.',
