...
describe('OpenClawConfigSync runtime config output', () => {
  ...
  test('writes OpenClaw config fields required by czclaw patches', async () => {
  ...
  test('writes managed browser policy forcing host target', async () => {
    ...
    expect(agentsMd).toContain('czclaw does not support sandbox browser execution in this version.');
