...
const WIN_INBOUND = String.raw`C:\Users\zhangsan\AppData\Roaming\czclaw\openclaw\state\media\inbound`;
const MAC_INBOUND = '/Users/zhangsan/Library/Application Support/czclaw/openclaw/state/media/inbound';
...
describe('czclaw goal mode command display', () => {
