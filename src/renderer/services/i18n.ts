...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    themeColor: '主题色',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 czclaw 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutDescNewChat: '开始一个新的 czclaw 任务',
    shortcutDescFocusPrompt: '跳回 czclaw 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 czclaw 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 czclaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'czclaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 czclaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 czclaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'czclaw 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 czclaw 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 czclaw 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 czclaw 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 czclaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'czclaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'czclaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 czclaw，你的全场景办公 Agent',
    ...
    coworkGoalInputPlaceholder: 'czclaw 应继续朝哪个目标努力？',
    ...
    browserWebAccessDescription: '使用 czclaw 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'czclaw 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 czclaw 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'czclaw 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 czclaw 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 czclaw 可以打开此域名',
    ...
    usageAnalyticsEnabled: '帮助改进 czclaw',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'czclaw服务协议',
    privacyDialogDesc: '在使用czclaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'czclaw服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用czclaw',
  ...
  en: {
    ...
    uiFontSizeDescription: 'Adjust the base size used for the czclaw UI',
    ...
    copied: 'Copied',
    copyrightHolder: 'czclaw. All rights reserved.',
    ...
    shortcutScopeHint: 'Shortcuts only run while the czclaw window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open czclaw',
    ...
    shortcutDescNewChat: 'Start a new czclaw task',
    shortcutDescFocusPrompt: 'Return to czclaw and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the czclaw task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit czclaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    artifactPreviewCardLobsterBrowser: 'Built-in Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in Built-in Browser',
    ...
    // czclaw
    cowork: 'czclaw',
    coworkSettings: 'czclaw Settings',
    ...
    coworkWorkingDirectoryHint: 'czclaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for czclaw...',
    coworkSystemPromptHint: "Optional system prompt to customize czclaw's behavior",
    ...
    coworkModelSettingsHint:
      'czclaw uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up czclaw data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import czclaw data',
    ...
    openClawDataMigrationConfirmTitle: 'Import czclaw data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save czclaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'czclaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'czclaw needs your input',
    ...
    coworkHomeTagline: "I'm czclaw, your all-in-one office agent",
    ...
    coworkGoalInputPlaceholder: 'What goal should czclaw keep working toward?',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add czclaw to your antivirus allowlist.',
    ...
    browserWebAccessDescription: 'Use the czclaw separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'czclaw starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for czclaw, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'czclaw will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means czclaw will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means czclaw can open this domain',
    ...
    usageAnalyticsEnabled: 'Help improve czclaw',
    ...
    // Privacy dialog
    privacyDialogTitle: 'czclaw Terms of Service',
    privacyDialogDesc:
      'Before using czclaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'czclaw Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to czclaw',
