...
const ABOUT_CONTACT_EMAIL = 'czclaw@users.noreply.github.com';
const ABOUT_USER_MANUAL_URL = 'https://github.com/czclaw/czclaw';
const ABOUT_USER_COMMUNITY_URL = 'https://github.com/czclaw/czclaw#community';
const ABOUT_SERVICE_TERMS_URL = 'https://github.com/czclaw/czclaw/blob/main/LICENSE';
      ...
      case 'about':
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            ...
            />
            <h3 className="text-lg font-semibold text-foreground">czclaw</h3>
            ...
            <div className="mt-auto w-full pt-14 pb-2 flex flex-col items-center">
              ...
              <p className="mt-1 text-center text-xs text-secondary">
                Copyright &copy; {new Date().getFullYear()} czclaw. All Rights Reserved.
              </p>
            </div>
          </div>
        );
