...
/**
 * Apply version-specific czclaw patches to the openclaw source tree.
 *
...
// This removes stale patches left by a different czclaw branch that may have
